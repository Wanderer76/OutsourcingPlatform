        ...
        <div className="main">
            { data !== undefined ?
                <>
                    <div className="user-personal">
                        <div className="user-card">
                            ...
                            <div className="user-data">
                                <p className="user-username">{!data.isClose ? data.surname + " " + data.name + " " + data.secondName :  data.userName}</p>
                                ...
                                <div className="last-row">
                                    <div className="social-card">
                                        ...
                                        {data.contacts === null || data.contacts === undefined || data.isClose ?
                                            ...
                                            <div className="links">
                                                {data.contacts.githubUrl !== null && data.contacts.githubUrl !== undefined &&
                                                    <a target="_blank" title={data.contacts.githubUrl.includes("github.com/") ? data.contacts.githubUrl : "https://github.com/" + data.contacts.githubUrl} href={data.contacts.githubUrl.includes("github.com/") ? data.contacts.githubUrl : "https://github.com/" + data.contacts.githubUrl}><img
                                                        className="social-logo" src={gitLogo} alt="Логотип Github"/></a>
                                                }
                                                {data.contacts.vkNickname !== null && data.contacts.vkNickname !== undefined &&
                                                    <a target="_blank" title={data.contacts.vkNickname.includes("vk.com") ? data.contacts.githubUrl : "https://vk.com/" + data.contacts.vkNickname} href={data.contacts.vkNickname.includes("vk.com/") ? data.contacts.githubUrl : "https://vk.com/" + data.contacts.vkNickname}><img
                                                        className="social-logo" src={vk} alt="Логотип VK"/></a>
                                                }
                                                {data.contacts.messager !== null && data.contacts.messager !== undefined &&
                                                    <a target="_blank" title={data.contacts.messager.includes("t.me") ? data.contacts.messager : "https://t.me/" + data.contacts.messager} href={data.contacts.messager.includes("t.me/") ? data.contacts.messager : "https://vk.com/" + data.contacts.messager}><img
                                                        className="social-logo" src={vk} alt="Логотип VK"/></a>
                                                }
                                            </div>
                                        }
                    ...
                    {'contacts' in data && 'about' in data.contacts && data.contacts.about !== "" && data.contacts.about !== null &&
                        <section className="about-user-person">
                            <h2>О себе:</h2>
                            <p className="about-person-text">{data.contacts.about}</p>
                        </section>
                    }
                    ...
                    {reviews.map((review) => {
                        ...
                        return <ReviewCard info={review} key={"review-"+review.id}/>
                            ...
                            {count > 10 && <input className="more-cards-btn" type="button" value="Показать больше"/> }
                        </div>
                    </section>
                    }
                </> :
