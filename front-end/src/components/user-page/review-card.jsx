        ...
        <div className="review-card">
            <div className="project-params">
                ...
                <div className="row">
                    ...
                    <p className="status">Закончен: <span>{new Date(props.info.projectCompleted).toLocaleString("ru", {year: 'numeric', month: 'long', day: 'numeric'})}</span></p>
                </div>
            </div>
            ...
            <input className="card-button project-button" type="button" value="Поcмотреть проект" onClick={() => window.location.href = "/tasks/" + props.info.orderId}/>
        </div>
    )
}
