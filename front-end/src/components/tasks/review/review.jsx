    ...
    return(
        ...
        <div className="main">
            <div className="new-review">
                ...
                <p className="navigation-after-title"><a href="/personal-area">личный кабинет</a>/<a href="#">написать отзыв</a></p>
                ...
                <div className="project-contractors contractor-card card">
                                ...
                                { userInfo[0].vkNickname !== "" &&
                                    <div className="contractor-data-card one-link">
                                        <img className="contractor-data-card link-icon" src={vkIcon}
                                             alt="link icon"/>
                                        <a className="contractor-data-card link-text" href="#">{userInfo[0].vkNickname}</a>
                                    </div>}
                                { userInfo[0].messager !== "" &&
                                    <div className="contractor-data-card one-link">
                    ...
                    <div className="project-contractors contractor-card column-2">
                            ...
                            <div className="consumer-data-card project-params">
                                <div className="consumer-data-card one-param">
                                    <img className="consumer-data-card param-icon" src={checklistIcon}
                                         alt="param icon"/>
                                        <p className="consumer-data-card param-text">Статус: <span>{userInfo[0].isOrderCompleted ? "Завершен" : "В процессе"}</span></p>
                                </div>
                                <div className="consumer-data-card one-param">
                        ...
                        <div className="project-contractors contractor-card buttons">
                            <a className="project-card-btn" href={"/executors/" + params.executorId}>Перейти к профилю</a>
                        </div>
                    </div>
                </div>
                ...
                <form className="new-review-form">
                    ...
                    <div className="review-block">
                        ...
                        <label className="visually-hidden" htmlFor="new-review-text">Отзыв на пользователя</label>
                        <p className="new-project__text visually-hidden" id="project-participant-number-error">Error
                            text (Текст ошибки)!</p>
                    </div>
