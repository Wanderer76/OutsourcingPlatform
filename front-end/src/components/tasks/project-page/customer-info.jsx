    ...
    return(
        ...
        <section className="consumer-data-card card">
            <div className="consumer-data-card column-1">
                ...
                <address>
                    <p className="consumer-data-card company-address">Адрес: { 'customer' in info ? info.customer.address : info.address}</p>
                ...
                <div className="consumer-data-card person-row">
                    ...
                    <p className="consumer-data-card person-name">{info.customer !== undefined ? info.customer.fullname : info.nickname}</p>
                </div>
                ...
                <div className="consumer-data-card project-params">
                    ...
                    {window.sessionStorage.getItem('role') === "customer" ?
                        <div className="consumer-data-card one-param">
                            ...
                            <p className="consumer-data-card param-text">Участники: <span>{props.info.projectParams.participansCount}</span></p>
                        </div> :
                        <></>
                    }
