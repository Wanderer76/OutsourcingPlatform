...
const NewExecutorCard = (props) => {
    ...
    let themes = props.info.categories.map((theme) => {return <div className="field-tag">{theme.name}</div>});
    let competence = props.info.skills.map((skill) => {return <div className="field-tag">{skill.name}</div>});;
    function accept() {
