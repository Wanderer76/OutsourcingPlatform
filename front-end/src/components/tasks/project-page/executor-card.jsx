...
const ExecutorCard = (props) => {
    ...
    return(
        <>
            {popup}
           <div className={props.info.isCompleted ? "project-contractors contractor-card card blue" : "project-contractors contractor-card card"}>
                    ...
                    <div className="project-contractors contractor-card contractor-data">
                        <div className="project-contractors contractor-card user-avatar">
                            <img className="project-contractors contractor-card avatar-image"
                                 src={props.info.avatar === undefined ? emptyUserIcon : props.info.avatar} alt="Аватар пользователя"/>
                        </div>
                ...
                <div className="project-contractors contractor-card column-2">
                        ...
                        <div className="consumer-data-card project-params">
                            <div className="consumer-data-card one-param">
                                <img className="consumer-data-card param-icon" src={checklistIcon}
                                     alt="param icon"/>
                                    <p className="consumer-data-card param-text">Статус: <span>{!props.info.isCompleted ? "В процессе" : "Завершен"}</span></p>
                            </div>
                            {props.info.projectStatus === "Завершен" ?
                                ...
                                <div className="consumer-data-card one-param">
                                    <img className="consumer-data-card param-icon" src={shakeHandsIcon}
                                         alt="param icon"/>
                                        <p className="consumer-data-card param-text">Проектов завершено: <span>{props.info.completedOrders}</span></p>
                                </div>
                            }
                    ...
                    <div className="project-contractors contractor-card buttons">
                        ...
                        {!props.info.isRated && props.info.isCompleted ?
                            <a className="project-card-btn blue" href={"/review/" + props.info.executorId + "/" + props.orderId} >Написать отзыв</a> :
                            !props.info.isCompleted && !props.isCompleted ? <a className="project-card-btn" onClick={viewPopup}>Удалить исполнителя</a> : <></>
                        }
