...
import {addElement, deleteElement} from "../add-check-delete-tags";
    ...
    useEffect(() => {
        ...
        axios.get(process.env.REACT_APP_API_URL+"/api/Order/detail_order_info/" + params.orderId,
            ...
            .then((response) => {
                ...
                setCompetence(response.data.orderSkills);
    ...
    const themesBlock = themes.map((theme) => {
        return(
            <div className="new-project-field-tag" key={theme}>
                ...
                <button className="delete-tag-btn" type="button" onClick={() => deleteElement(theme, themes, setTheme)}>x</button>
            </div>
        )
    })
    ...
    const competenceBlock = competence.map((comp) => {
        return(
            <div className="new-project-skill-tag" key={comp}>
                ...
                <button className="delete-tag-btn" type="button" onClick={() => deleteElement(comp, competence, setCompetence)}>x</button>
            </div>
        )
    })
        ...
        // <><Header />
            <div className="main">
                <section className="new-project">
                    ...
                    <p className="navigation-after-title"><a href="/personal-area">личный кабинет</a>/<a href="/tasks/create">форма создания заказа</a>
                    </p>
                    ...
                    <form className="new-project" name="new-project">
                        ...
                        <div className="new-project__field project-name">
                            ...
                            <textarea className="new-project__field project-name" placeholder="Введите название заказа"
                                      name="name" id="project-name" rows="4" autoComplete="off" onInput={removeErrorMessageForInputs}></textarea>
                            <label className="visually-hidden" htmlFor="project-name">Название проекта</label>
                            <p className="new-project__text visually-hidden" id="project-name-error">Обязательно укажите название вашего замечательного проекта!</p>
                        </div>

                        <div className="new-project__field project-description">
                            <p>Описание задачи</p>
                            <textarea className="new-project__field project-description" placeholder="Введите описание задачи"
                            ...
                            <p className="new-project__text visually-hidden" id="project-description-error">Обязательно введите описание, так исполнитель будет понимать, что ему делать</p>
                        </div>
                        ...
                        <div className="inputs-row">
                            <div className="new-project__field project-deadline">
                                ...
                                <p className="new-project__text visually-hidden" id="project-deadline-error">Укажите срок выполнения проекта</p>
                            </div>
                        ...
                        <div className="inputs-row">
                            <div className="new-project__field project-new-field">
                                ...
                                <select className="new-project-select" name="project-new-field" id="project-new-field" onChange={() => {
                        ...
                        <div className="new-project-fields">
                            ...
                            <p className="new-project__text visually-hidden" id="project-new-field-error">Выберите в какой сфере ваш проект</p>
                        </div>
                        ...
                        <div className="inputs-row" id="competence-selector">
                            <div className="new-project__skill project-new-skill">
                                <p>Компетенции</p>
                                <select className="new-project-select" name="project-new-skill" id="project-new-skill" onChange={() => {
                        ...
                        <div className="new-project-skills" id="competence-selected">
                            ...
                            <p className="new-project__text visually-hidden" id="project-new-skill-error">Выберите необходмые компетенции или, если вы не знаете какие нужны, укажите это</p>
                        </div>


                        <div className="new-project__btns">
                            <input type="button" className="new-project-btn new-project-submit-btn" value="Сохранить"
                                   id="new-project-submit" onClick={() => sendData(themes, competence, process.env.REACT_APP_API_URL+"/api/Order/update/" + params.orderId, params.orderId)}/>
                                <input type="button" className="new-project-btn new-project-submit-cancel"
                                       value="Отменить" id="new-project-cancel" onClick={() => {window.location.href = "/tasks/my/" + params.orderId}}/>
                        </div>
