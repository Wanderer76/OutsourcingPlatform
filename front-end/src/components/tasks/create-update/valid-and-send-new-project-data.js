...
function validData(themes, competence) {
    let data = {}
...
export function sendData(themes, competence, url, orderId=-1) {
    let data = validData(themes, competence);
    if (data !== false)
