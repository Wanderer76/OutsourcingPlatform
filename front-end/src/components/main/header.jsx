        ...
        <header className="main-header">
            ...
            <nav className="nav">
                <ul className="nav-menu">
                    <li className="nav-for-mobile"><a href={username !== null ? "/personal-area" : "/signin"}>Личный кабинет</a></li>
                ...
                <div className="notification-block visually-hidden" id="notifications-block">
                    <div className="notification-list">
                        {notifications.map((notification) => {return <Notification key={notification.id} notification={notification} onClick={() => {
                            connection.invoke("SetNotificationViewed", notification.id);
                            window.location.href = window.sessionStorage.getItem('role') === 'customer_role' ? '/tasks/my/' + notification.orderId : '/tasks/'+notification.orderId;
                        }}/>})}
                    </div>
