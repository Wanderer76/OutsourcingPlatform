                ...
                <form className="new-project" name="new-project">
                    ...
                    <div className="user-personal-data block">
                        ...
                        <div className="user-personal-data column-2">
                            <div className="user-data-edit__field">
                                <p>Дата рождения</p>
                                <input className="user-data-edit_input" type="date" name="birth-date" id="birth-date" onChange={event => change("birthDate", event.target.value, setRes, res)}/>
                            ...
                            <div className="user-data-edit__field">
                                ...
                                <p className="input-error__text visually-hidden" id="city-error">Error text (Текст ошибки)!</p>
                            </div>
                                ...
                                <div className="user-data-edit__field password">
                                    ...
                                    <div className="password-with-control">
                                        <input type="password" id="user-password"
                                               name="password" className="user-data-edit_input error" onChange={() => changePassword()}/>
                    ...
                    <div className="new-project__field person-description">
                        ...
                        <textarea className="new-project__field person-description" placeholder="Напишите о себе"
                                  ...
                                  autoComplete="off" onChange={(e) => {links.about = e.target.value}}></textarea>
                        ...
                        <div className="new-project-field-tags">
                            { categories !== undefined ? categories.map((cat) => {
                                ...
                                <div className="new-project-field-tag">
                                    ...
                                    <button type="button" className="delete-tag-btn" onClick={() => deleteElement(cat, categories, setCategories)}>x</button>
                                </div>)
                            }) : <></>}
                    ...
                    <div className="inputs-row">
                        <div className="new-project__skill project-new-skill">
                            <p>Компетенции</p>
                            <select className="new-project-select" name="project-new-skill" id="project-new-skill" onChange={() => {if (skills.length < 5) addElement("project-new-skill", skills, setSkills)}}>
                                <option value="">-- Выберите компетенцию --</option>
                                {skillsView}
                            </select>
                            <label className="visually-hidden" htmlFor="project-new-skill">Компетенци</label>
                        </div>
                    </div>
                            ...
                            { skills !== undefined ? skills.map((skill) => {
                                return(
                                    <div className="new-project-field-tag">
                                        ...
                                        <button type="button" className="delete-tag-btn" onClick={() => deleteElement(skill, skills, setSkills)}>x</button>
                                    </div>)
                            }) : <></>}
                        </div>
                        ...
                        <div className="user-education-info column-1">
                            ...
                            <div className="new-education__field education-place" id="education-place-block">
                                ...
                                <input className="new-education__field" name="education-place" id="education-place"
                                    ...
                                    <p className="new-education__text visually-hidden" id="education-place-error">Введите место обучения</p>
                            </div>
                            ...
                            <div className="new-education__field education-year" id="education-year-block">
                                <p>Год окончания</p>
                                <input class="new-education__field" type="number" min="1900" max="2099" defaultValue={2023} step="1" name="education-year" id="education-year" autoComplete="off" onChange={() => {
                                    ...
                                    <p className="new-education__text visually-hidden" id="education-year-error">Введите год окончания обучения, если еще не закончили, укажите предполагаемый</p>
                            </div>
                            ...
                            <input type="button" className="new-project-btn" value="Добавить" id="add-new-education" onClick={() => validAndAddEdu()}/>
                        </div>
                                    ...
                                    edus.map(edu => {
                                        return(
                                            <div className="user-education-info education-row-card">
                                                ...
                                                <button className="delete-edu-btn" type="button" onClick={() => deleteElement(edu, edus, setEdu)}>x</button>
                                            </div>
                                        )
                                    }) :
                                    <></>
                    ...
                    <div className="new-project__btns">
                        <button type="button" className="new-project-btn new-project-submit-btn" value="Сохранить"
                            ...
                            sendData(process.env.REACT_APP_API_URL+"/api/PersonalArea/executor/update", res);
