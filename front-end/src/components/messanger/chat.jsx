            ...
            <div className="chat-item-text-content">
                <div className="chat-item-first-row">
                    <div className="chat-item-name">
                        <p className="chat-sender-name">{chatInfo.receiverName + " " + chatInfo.receiverSurname}</p>
                        {chatInfo.unreadCount > 0 && <div className="message-counter">{chatInfo.unreadCount}</div>}
                    </div>
                    <p className="chat-item-time">14:22</p>
                </div>
                {window.sessionStorage.getItem('role') === 'executor_role' && <p className="chat-item-company-name">{chatInfo.companyName}</p>}
