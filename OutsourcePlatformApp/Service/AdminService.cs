...
public class AdminService
{
    ...
    public async Task<ExecutorAdminDetailDto> GetExecutorInfo(User? user)
    {
        ...
        var finishedProjects = await executorRepository.GetFinishedCountProjectsAsync(user.Executor.ExecutorId);
        var notFinishedProjects = await executorRepository.GetProjectsCountAsync(user.Executor.ExecutorId);
    ...
    public async Task<CustomerAdminDetailDto> GetCustomerInfo(User? user)
    {
        ...
        var finishedProjects = await customerRepository.GetFinishedCountProjectsAsync(user.Customer.CustomerId);
        var notFinishedProjects = await customerRepository.GetProjectsCountAsync(user.Customer.CustomerId);
