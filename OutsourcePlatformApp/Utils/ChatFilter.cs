        ...
        HubInvocationContext invocationContext, Func<HubInvocationContext, ValueTask<object>> next)
    {
        ...
        try
        {
            ...
            if (methodName.Equals("Send"))
            {
                ...
                var sender = await userRepository.GetUserByRefreshToken(userToken);
                ...
                var receiver =
                    await (sender.UserRoles.Any(role => role.Name.Equals(UserRolesConstants.ExecutorRole))
                        ? userRepository.GetCommonUserByCustomerIdAsync(chat.CustomerId)
                        : userRepository.GetCommonUserByExecutorIdAsync(chat.ExecutorId));
